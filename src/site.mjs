...
export const site = {
  ...
  role: "предприниматель, CFO-консультант, стратегический модератор, практикующий психолог",
  title: "Елена Рендаревская — финансы, психология и управление бизнесом",
  description:
    "Разборы для предпринимателей о финансах, стратегии, управлении и психологии решений. Автор — Елена Рендаревская, CFO-консультант и практикующий психолог.",
