...
export const site = {
  ...
  title: "Елена Рендаревская — авторский сайт о бизнесе и человеке",
  description:
    "Авторский сайт Елены Рендаревской. Статьи о деньгах, управлении и психологии собственника — чтобы видеть цену решений для компании и для себя.",
